...
//: In our earlier example, we added the 'square' function using our extension.
//: Let's create a new protocol with the 'square' function.
//: Then we can create an extension on any of the numbered types (Int, Double, Float, etc.) and have it conform to our new protocol
